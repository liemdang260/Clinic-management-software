...
export const getAppointmentInDay = async (req, res) => {
  try {
...
export const getAppointmentByWeek = async (req, res) => {
...
export const createDianosticNew = async (req, res) => {
  //FromAPPOINTMENT
  try {
    let id = req.params.id;
    let appointment = await APPOINTMENT.findOne({
...
export const getDiagnosticStack = async (req, res) => {
